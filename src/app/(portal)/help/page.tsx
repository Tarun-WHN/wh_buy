...
const MODULES: ModuleGuide[] = [
  ...
  },
  {
    ...
    name: "AI Copilot",
    accent: "#F47B20",
    what: "A chat assistant that answers procurement questions from your real data.",
    how: "Ask in plain English — cheapest supplier for X, vendors in a city, spend & top vendors, inactive vendors. Needs the AI key configured.",
  },
  {
    slug: "ai-tools",
    icon: Wand2,
    ...
    accent: "#8b5cf6",
    what: "Standardize differently-named vendor products and auto-classify SKUs into your taxonomy.",
    how: "Paste vendor descriptions to group them into standard SKUs, or enter a product to get a suggested Category → Sub-category → Group.",
  },
  {
    slug: "contracts",
    icon: FileSignature,
    ...
    accent: "#0ea5e9",
    what: "Extracts key terms from a vendor contract PDF/image (validity, price lock, payment, penalty, warranty, AMC, renewal).",
    how: "Upload the contract and click Analyze — review the extracted terms against the source.",
  },
  {
